...
void loop(void) {
  ...
  if (comenzo == "si" && (millis() - tiempoPrevio) >= tiempoEspera) {
    ...
    if (digitalRead(infrarrojo) == 0 && estadoAnterior == 1){
      ...
      webSocket.broadcastTXT(tiempoVueloStr);
