        ...
        case WStype_TEXT:
              { 
                ...
                if (error){
                  ...
                  const char* edad= json_payload_receive["edad"];
                  const char* categoria = json_payload_receive["categoria"];
                  Serial.println(String(nombre) + "-" + String(edad) + "-" + String(categoria));
